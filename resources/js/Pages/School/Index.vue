  ...
  <authenticated-layout>
    <section class="py-5 mt-5">
      <div class="container d-flex gap-4 flex-column justify-content-start align-items-start">
        ...
        <Link class="btn btn-success" :href="route('schools.create')">اضافة مدرسة</Link>
            ...
            <tbody>
              <tr v-for="school in schools" :key="school.id">
                ...
                <td class="d-flex gap-2 justify-content-center">
                  <Link class="btn btn-sm btn-warning" :href="route('schools.edit',school.id)">تعديل</Link>
...
export default {
  ...
  watch: {
    search: debounce(function (newSearch, oldSearch) {
      this.$inertia.get(route('schools.index'), {'search': newSearch}, {preserveState: true, replace: true})
    }, 500)
  },
  methods: {
    filterSchools () {
